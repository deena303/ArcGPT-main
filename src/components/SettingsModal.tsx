      ...
      <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl space-y-5">
        ...
        <div className="space-y-3.5 text-xs text-slate-700">
          ...
          <div className="rounded-xl border border-slate-200 p-3 space-y-1">
            ...
            <p className="text-[11px] text-slate-500">
              Connected to the local PostgreSQL institution database through the server-side Express API.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-slate-200 p-3 space-y-1">
            ...
            <p className="text-[11px] text-slate-500">
              Structured SQL validation blocks DDL/DML, multi-statement injection, system catalogs, and unauthorized tables before execution.
            </p>
          </div>
        </div>
